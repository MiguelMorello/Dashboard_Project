    ...
    <div ref={setNodeRef} style={{display:'flex', flexDirection:'column', padding:'0 16px'}}>
      ...
      <div style={{padding:'12px'}}>
        ...
        <Space style={{width:'100%', justifyContent: 'space-between' }}>
          ...
          <Space>
            <Text ellipsis={{tooltip: title}} size="xs" strong style={{textTransform:'uppercase', whiteSpace:'nowrap'}}>
              {title}
            </Text>
      ...
      <div style={{flex:1, overflowY: active ? 'unset' : 'auto', border: '2px dashed transparent', 
      borderColor: isOver ? '#000040' : 'transparent', borderRadius:'4px'}}>
