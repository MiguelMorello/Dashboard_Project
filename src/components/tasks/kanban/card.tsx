  ...
  return (
    <ConfigProvider theme={
      {components:
        ...
        <Card size='small'title={<Text ellipsis={{tooltip: title}}>{title}</Text>} onClick={() => edit('task', id, 'replace')}
        extra={
        <Dropdown trigger={["click"]} menu={{items:dropdownItems, onPointerDown:(e) => {e.stopPropagation()}, onClick:(e) => {e.domEvent.stopPropagation()}}} 
        placement="bottom" arrow={{pointAtCenter: true}}>
          ...
          <div style={{display:'flex', flexWrap:'wrap', alignItems:'center', gap:'8px'}}>
              ...
              {dueDateOptions && (
                ...
                style={{padding:'0 40px', marginInlineEnd:'0', backgroundColor:dueDateOptions.color === 'default'? 'transparent' : 'unset',}}
